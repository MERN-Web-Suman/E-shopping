...
export default function Banner2() {
  return (
    ...
    <div className='container' >
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl bg-[red]'>
            {/* first col */}
            <div className='p-6 sm:p-8'>
                <p className='text-sm'>30% OFF</p>
                <h1 className='uppercase text-4xl lg:text-7xl font-blod' >HAPPY HOURS</h1>
                <p className='text-sm'>10 Jan to 28 Jan</p>
            </div>
            <div className='h-full flex items-center'>
                <img src="smartwatch2-removebg-preview.png" className='scale-125 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover ' />
            </div>
